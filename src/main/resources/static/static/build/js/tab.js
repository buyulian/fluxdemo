    ...
    var _tab = {
        ...
        tabDomExists: function() {
            ...
            if (_doc.find('div.kit-tab').length > 0) {
                ...
                that._content = $('.kit-tab div.layui-tab-content-kit');
                return true;
            }
            return false;
        },
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> 系统公告</li>',
                    '</ul>',
                    ...
                    '</ul>',
                    '</div>',
                    '<div class="layui-tab-content-kit">',
        ...
        load: function() {
            return layer.load(2, { shade: [0.3, '#333'] });
        },
        ...
        winResize: function() {
            ...
            _win.on('resize', function() {
                ...
                switch (_config.renderType) {
                    case renderType.page:
                        $('.kit-tab .layui-tab-content-kit').height(currBoxHeight - 43);
                        break;
                    case renderType.iframe:
                        $('.kit-tab .layui-tab-content-kit iframe').height(currBoxHeight - 47);
                        break;
                }
            }).resize();
        },
